...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/henricus/Documents/RobotLab/Workspace/Robot_Lab/src/navigation)
  set(navigation_DEVEL_PREFIX /home/henricus/Documents/RobotLab/Workspace/Robot_Lab/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/henricus/Documents/RobotLab/Workspace/Robot_Lab/install)
...
if(NOT "/home/henricus/Documents/RobotLab/Workspace/Robot_Lab/devel/include" STREQUAL "")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/henricus/Documents/RobotLab/Workspace/Robot_Lab/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'henricus <henricus@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/henricus/Documents/RobotLab/Workspace/Robot_Lab/src/navigation/${idir}'.  Ask the maintainer 'henricus <henricus@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/henricus/Documents/RobotLab/Workspace/Robot_Lab/devel/lib;/opt/ros/indigo/lib)
